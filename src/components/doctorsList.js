        ...
        <div className="w-full">
            <div className="w-full flex flex-col items-center gap-6">
                <div className="w-3/4">
                    ...
                    <p className="font-extralight text-md text-gray-700">Search doctors by specialization and mode</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-3/4">
                        <div className="flex flex-col gap-2 border border-md">
                            ...
                            <div className="p-2">
                                <p className="border border-md w-full text-sm p-1 text-green-700 font-semibold">Cardiology</p>
                                <h2 className="font-bold mt-2 text-black-500 text-xl">Dr. Keerthana</h2>
                                <p className="text-gray-500 font-extralight">In-person</p>
                            </div>
                            <div className="bg-[#4dae37] hover:bg-green-500">
                                <button className="p-2 w-full text-white font-semibold text-sm">Book An Appointment</button>
                            </div>
                        </div>
                </div>
            </div>
